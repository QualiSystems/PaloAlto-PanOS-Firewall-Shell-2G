...
from cloudshell.firewall.paloalto.panos.snmp.panos_snmp_handler import PanOSSnmpHandler as SnmpHandler
from cloudshell.firewall.paloalto.panos.runners.panos_autoload_runner import PanOSAutoloadRunner as AutoloadRunner
...
class PaloAltoShellDriver(ResourceDriverInterface, FirewallResourceDriverInterface, GlobalLock):
